...
Page({
  ...
  data: {
    ...
    result: 
      [
        {
          answer: "A",
          cate_name: '岗位能力--言语理解与表达',
          category: 84,
          comments: 'B；项，介词滥用，导致主语残缺，应去掉“由于”。C；项，动宾搭配不当，“度过”的不能是“重大选择”。D；项成分残缺，应在“工作”后加“的人”。故本题答案为；A。',
          comments_imgs: '',
          course: 13,
          course_name: '公共科目',
          id: 1,
          ...
          option_type: 0,
          type: 1,
          choseList: '{"A":"近年来，大部分学校都把主要精力放在了学生专业知识的培养上，而忽略了学生正确人生观、世界观的培养和教育。", "B":"拉萨江东父老家","C":" lahsdfk"}'
        },
        {
          answer: "A",
          cate_name: '岗位能力--言语理解与表达',
        ...
        var data = [
          {
            ...
            media_type: 0,
            option_type: 0,
            options: '{"A":"近年来，大部分学校都把主要精力放在了学生专业知识的培养上，而忽略了学生正确人生观、世界观的培养和教育。", "B":"拉萨江东父老家","C":" lahsdfk"}'
          }
        ]
        console.log(data)
        var start = 1;
  ...
  fromBegin(menu){
    ...
    this.Countdown(parseInt(1) * 60000)
    this.setThisData(0)
  },
  //设置当前题目
  setThisData(i) {
    ...
    const that = this;
    console.log(r.length, 28444444444)
    if (r.length == 0) {
      wx.redirectTo({
